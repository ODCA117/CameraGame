...
public class MyJavaCameraView extends CameraBridgeViewBase implements PreviewCallback {
    ...
    /**
     * TODO: Change this so that it choose the highest up to 720*480 instead of 5th highest
    ...
    protected Size calculateCameraFrameSize(List<?> supportedSizes, ListItemAccessor accessor, int surfaceWidth, int surfaceHeight) {
        return new Size(accessor.getWidth(supportedSizes.get(4)), accessor.getHeight(supportedSizes.get(4)));
    }
}
